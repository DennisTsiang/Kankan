...
function Database(pool) {
    ...
    this.newTicket = async (function (pid, ticket, columnName) {
        rwlock.writeLock(function () {
            try {
                ...
                if (check_ticket.rows.length > 0) throw SQLException;
                ...
                if (columnInfo.length === 0) throw SQLException;//TODO: Return error -> 'bok' response.
    ...
    this.moveTicket = async (function (pid, ticket, toColumnName, fromColumnName) {
        rwlock.writeLock(function () {
            ...
            if (checkCurrentColumn.row.length !== 1) throw SQLException;
